  ...
  //
  //             /// 🌟 Legendary Logo with Rotating Ring
  //             _legendaryLogo(),
  //
  ...
  //             const SizedBox(height: 40),
  //
  //             /// Glassmorphism Panel for Input Fields
  //             Container(
  ...
  //                 children: [
  //
  //                   _goldField("Full Name"),
  //                   const SizedBox(height: 20),
  //                   // _goldField("Email"),
  //                   _goldField("Email", controller: emailController),
  //                   const SizedBox(height: 20),
  //                   // _goldField("Password", isPassword: true),
  //                   _goldField("Password", isPassword: true, controller: passwordController),
  //
  //                   const SizedBox(height: 40),
  //
  //                   // _luxuryGoldButton("SIGN UP", () {
  //                   //   Navigator.pushNamed(context, 'dashboard');
  //                   // }),
  //
  //                 _luxuryGoldButton("SIGN UP", () async {
  //                   try {
  ...
  //   }
  //
  //   /// ⭐ Legendary Logo with Rotating Liquid Gold Ring
  ...
  //           ),
  //
  //           /// Rotating Liquid Gold Sweep Ring
  //           AnimatedBuilder(
  //             animation: _controller,
  //             builder: (_, __) {
  ...
  //   }
  //
  //   // Widget _goldField(String hint, {bool isPassword = false}) {
  //   //   return TextField(
  ...
  //       _showSnack("Enter valid email & password (min 6 chars)");
  //       return;
  //     }
  //
  //     try {
  ...
  //   }
  //
  //   /// (Your logo, particle & painter code remains EXACTLY SAME)
  //   /// I’m keeping it unchanged below 👇
  //
  //   Widget _legendaryLogo() {
  //     return const SizedBox(); // <-- keep your existing implementation
  //   }
  //
  //   Widget _goldField(String hint,
  //       {bool isPassword = false,
  ...
  //   }
  //
  //   /// 🔥 Register Logic with Firestore & Email Verification
  //   Future<void> _register() async {
  //     if (fullNameController.text.trim().isEmpty ||
  //         emailController.text.trim().isEmpty ||
  //         passwordController.text.trim().length < 6) {
