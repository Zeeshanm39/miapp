...
//
//
// //   Widget _liquidGoldButton(String text, VoidCallback onPressed) {
...
// // }
//
//  _liquidGoldButton("ACCESS PORTAL", () async {
//   try {
...
// import 'package:shimmer/shimmer.dart';
// import 'package:firebase_auth/firebase_auth.dart';
// import 'verify_email.dart'; // make sure this import is correct
//
// class MyLogin extends StatefulWidget {
//   const MyLogin({super.key});
//
...
//   }
//
//   /// 🔐 FIREBASE LOGIN BUTTON WITH EMAIL VERIFICATION CHECK
//   Widget _liquidGoldButton(String text) {
//     return GestureDetector(
//       onTap: () async {
//         try {
...
//             // Redirect to VerifyEmailScreen if email not verified
...
//           }
//
//           // Navigate to dashboard if email verified
//           Navigator.pushReplacementNamed(context, 'dashboard');
//         } on FirebaseAuthException catch (e) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
